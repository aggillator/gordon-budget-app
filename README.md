...
- **Monthly trends**: new "Trends" tab (next to Averages) shows total income, spending, and net per month as a bar chart, plus all-time averages and how this month compares to last. Transfers and refunds (anything in a budget-excluded category) don't count toward either side.
